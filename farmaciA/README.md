...
Apagar Produto: Remova um produto do estoque fornecendo seu nome.

Mostrar Produtos: Visualize todos os produtos em uma tabela detalhada.

Estrutura do Código: ServiceInterface.java: Contém a implementação da interface gráfica e a lógica para interação com o estoque.
